...
# Student-W2V
bash ./run_5_times.sh pairs --lr 0.0005 --no_seed_weights --logdir $logdir/$(date +'%h%d_%H-%M-%S-%N')_W2V --emb_dropout 0.5 --weight_decay 0.1 --loss SmoothCrossEntropy

# Student-BERT
# bash ./run_5_times.sh pairs --lr 0.00005 --no_seed_weights --logdir $logdir/$(date +'%h%d_%H-%M-%S-%N')_BERT --emb_dropout 0.5 --weight_decay 0.0001 --use_bert
